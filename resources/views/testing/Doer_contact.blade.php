...
<div class="loreg_card">
    ...
    <form action="{{ route('contact.submitForm') }}" method="POST" class="contact doer-contact-form">
        ...
        <input type="date" name="date" id="date" required="required" class="date-area" />
        <textarea name="message" id="message" placeholder="Your message here and I'll answer as soon as possible" required="required" class="leave-review-text"></textarea>
